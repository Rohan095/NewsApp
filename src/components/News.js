...
export class News extends Component {
  ...
  async fetchData(page){
    let url = `https://newsapi.org/v2/top-headlines?category=${this.props.topic}&apiKey=136cef8718984499a18771d56b327550&pageSize=12&page=${this.state.page}`;
  ...
  render() {
    ...
    return (
      <div className="container">
        <h1><b>NEWSTODAY TOP HEADLINES</b></h1>
        {this.state.loading &&<GridLoader  className='load' color="#36d7b7" loading size={30}/>}
        <div className='row'>
        ...
        {!this.state.loading && <div className="btnsection">
