...
export class Technology extends Component {
  ...
  async fetchData(page){
    let url = `https://newsapi.org/v2/top-headlines?category=technology&apiKey=136cef8718984499a18771d56b327550&pageSize=12&page=${this.state.page}`;
  ...
  render() {
    ...
    return (
      <div className="container">
        <h1>TECHNOLOGY - TOP HEADLINES</h1>
        {this.state.loading &&<ClockLoader  className='load' color="#36d7b7" loading size={100}/>}  
        <div className='row'>
