...
export class Science extends Component {
  ...
  async fetchData(page) {
    let url = `https://newsapi.org/v2/top-headlines?category=science&apiKey=136cef8718984499a18771d56b327550&pageSize=12&page=${page}`;
  ...
  render() {
    ...
    return (
      <div className="container">
        <h1>SCIENCE - TOP HEADLINES</h1>
        {this.state.loading &&<RingLoader  className='load' color="#36d7b7" loading size={120}/>}
        <div className='row'>
          {this.state.articles.map((element) => {
            return (
              ...
              <div className="col-md-4" key={element.url}>
                <Newsitem 
                  title={element.title ? element.title.slice(0, 100) : "No Title"} 
